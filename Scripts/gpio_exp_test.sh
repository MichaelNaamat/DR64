...
declare -r GPIO_REG_DOUT0="0x02"
declare -r GPIO_REG_DOUT1="0x03"
declare -r GPIO_REG_POL0="0x04"
declare -r GPIO_REG_POL1="0x05"
declare -r GPIO_REG_CONF0="0x06"
declare -r GPIO_REG_CONF1="0x07"
...
function gpio_check_dev()
{
    ...
    dout1=$(i2cget -y -f $bus $dev $GPIO_REG_DOUT1)
    pol0=$(i2cget -y -f $bus $dev $GPIO_REG_POL0)
    pol1=$(i2cget -y -f $bus $dev $GPIO_REG_POL1)
    conf0=$(i2cget -y -f $bus $dev $GPIO_REG_CONF0)
    conf1=$(i2cget -y -f $bus $dev $GPIO_REG_CONF1)
